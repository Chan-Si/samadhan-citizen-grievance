export const STATES_AND_DISTRICTS: Record<string, string[]> = {
  ...
  'Arunachal Pradesh': [
    ...
    'Siang', 'Upper Siang', 'Lower Siang', 'Dibang Valley', 'Lower Dibang Valley', 
    'Lohit', 'Anjaw', 'Changlang', 'Tirap', 'Longding', 'Namsai', 'Kamle', 
  ...
  'Gujarat': [
    ...
    'Bhavnagar', 'Botad', 'Dahod', 'Dang', 'Devbhoomi Dwarka', 'Gandhinagar', 
  ...
  'Himachal Pradesh': [
    'Bilaspur', 'Chamba', 'Hamirur', 'Kangra', 'Kinnaur', 'Kullu', 
  ...
  'Tamil Nadu': [
    ...
    'Namakkal', 'Nilgiris', 'Perambbalur', 'Pudukkottai', 'Ramanathapuram', 
  ...
  'Jammu and Kashmir': [
    ...
    'Jammu', 'Kathua', 'Kishtwar', 'Kulgam', 'Kupwara', 'Mendhar', 
